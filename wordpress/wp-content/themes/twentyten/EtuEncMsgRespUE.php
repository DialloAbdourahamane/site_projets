...
<?php
/**
 Template Name: Envoyer message au resp Ue
 */
...
<body> 
  ...
  <form name="mail_form" method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/testEnvoiProf.php" target="target"> 
   ...
   <legend class="style-legend"> Envoyer un message au responsable de l'UE </legend> 
	
     <input type="hidden" name="destinataire" value="<?php echo 'bernard.cherbonneau@irit.fr'; ?>">
