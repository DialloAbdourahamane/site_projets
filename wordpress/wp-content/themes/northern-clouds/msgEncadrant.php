...
$_SESSION['mail']=$current_user->user_email;
?>
<?php endif; ?>

<?php
/**
 Template Name: Envoyer message a un encadrant projet
 */
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
 <form name="mail_form" method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/testEnvoiProf.php"> 
  	<fieldset class="style-fieldset" > 
   <legend class="style-legend"> Envoyer un message à un encadrant </legend> 
