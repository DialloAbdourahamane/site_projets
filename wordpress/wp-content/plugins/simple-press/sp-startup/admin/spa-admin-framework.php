...
Simple:Press
Admin Panels
$LastChangedDate: 2013-01-26 04:52:52 -0700 (Sat, 26 Jan 2013) $
$Rev: 9771 $
*/
...
function spa_load_admin_scripts() {
	global $APAGE, $ISFORUMADMIN, $SPSTATUS, $current_screen, $SFMOBILE, $SFDEVICE;
...
?>
	<script type='text/javascript'>
    	...
    	var sp_platform_vars = {
    		"focus":"admin",
    		"mobile":"<?php echo($SFMOBILE); ?>",
    		"device":"<?php echo($SFDEVICE); ?>",
    		"tooltips":"1",
    		"mobiletheme":"0"
    	};
    	/* ]]> */
...
function spa_admin_header() {
	global $ISFORUMADMIN, $SPSTATUS, $spThisUser, $current_user;
...
function spa_admin_init_scripts() {
	global $SPSTATUS, $APAGE, $ISFORUMADMIN, $sfactivepanels;
...
?>
			<script type="text/javascript">
				...
				jspf(document).ready(function() {
                    ...
                    <?php if (((defined('SP_USE_PRETTY_CBOX_ADMIN') && SP_USE_PRETTY_CBOX_ADMIN == true) || !defined('SP_USE_PRETTY_CBOX_ADMIN')) && $APAGE != 'plugins') { # Checkboxes/radio buttons ?>
...
function spa_render_sidemenu() {
	...
	echo '<br /><input type="button" id="spHelp" class="button-primary" value="'.sp_splice(spa_text('Simple:Press‌ Help and Troubleshooting'),2,0).'" onclick="spjTroubleshooting(\''.$site.'\', \''.$target.'\');" />'."\n";
	echo '</div>'."\n";
}
