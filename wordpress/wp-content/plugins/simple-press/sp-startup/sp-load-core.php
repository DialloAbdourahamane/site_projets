...
global $ISADMIN, $ISFORUMADMIN, $SPSTATUS, $SPPATHS;
# ------------------------------------------------------------------------------------------
...
if ($SPSTATUS == 'ok') {
	...
	# special call to allow plugins to filter $sfglobals
	sp_filter_globals();
}
# ------------------------------------------------------------------------------------------
...
if ($sfrpx['sfrpxenable']) {
	...
	add_action('login_head', 		'sp_rpx_login_head');
...
add_action('cron_schedules', 				'sp_cron_schedule');
