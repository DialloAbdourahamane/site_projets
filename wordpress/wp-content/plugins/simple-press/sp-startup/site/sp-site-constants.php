...
$LastChangedDate: 2013-01-17 09:03:03 -0700 (Thu, 17 Jan 2013) $
$Rev: 9733 $
*/
...
global $wpdb, $SPPATHS, $SFMOBILE, $SFDEVICE;
...
if (!defined('SPTHEMEICONSURL')) {
	$p = ($SFDEVICE=='mobile' && file_exists(SPTHEMEBASEDIR.$curTheme['theme'].'/images/mobile/')) ? $curTheme['theme'].'/images/mobile/' : $curTheme['theme'].'/images/';
//	define('SPTHEMEICONSURL',	SPTHEMEBASEURL.$curTheme['theme'].'/images/');
...
if (is_multisite()) {
    if (!defined('SP_COMBINED_CACHE_URL'))	     define('SP_COMBINED_CACHE_URL', SF_STORE_URL.'/blogs.dir/'.SFBLOGID.'/files');
    if (!defined('SP_COMBINED_CACHE_DIR'))	     define('SP_COMBINED_CACHE_DIR', SF_STORE_DIR.'/blogs.dir/'.SFBLOGID.'/files');
} else {
    if (!defined('SP_COMBINED_CACHE_URL'))	     define('SP_COMBINED_CACHE_URL', SF_STORE_URL);
    if (!defined('SP_COMBINED_CACHE_DIR'))	     define('SP_COMBINED_CACHE_DIR', SF_STORE_DIR);
}
