...
function spa_users_members_form() {
	...
	spa_paint_open_tab(spa_text('Users').' - '.spa_text('Member Information'));
					...
					<table class="sfsubtable">
						<thead>
							<tr class="thead">
								...
								<th><?php spa_etext('Display Name') ?></th>
...
?>
    								<tr id="user-delete-<?php echo $userid; ?>">
    									...
    									<td><strong><?php echo sp_filter_name_display($displayname); ?></strong></td>
