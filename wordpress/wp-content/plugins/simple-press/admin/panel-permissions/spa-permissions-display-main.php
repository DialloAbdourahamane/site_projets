...
<?php
					...
					$image = SFADMINIMAGES;
?>
					<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Edit Permission'),0,0); ?>" onclick="spjLoadForm('editperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $role->role_id; ?>');" />
				</td>
				<td align="center">
					<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Delete Permission'),0,0); ?>" onclick="spjLoadForm('delperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $role->role_id; ?>');" />
				</td>
			</tr>
