...
$LastChangedDate: 2012-12-01 10:49:48 -0700 (Sat, 01 Dec 2012) $
$Rev: 9442 $
*/
...
function spa_save_uninstall_data() {
	...
	if (isset($_POST['sfuninstall'])) $mess = spa_text('Simple:Press will be removed when de-activated');
...
function spa_save_inspector_data() {
	...
	$ins[$i]['con_sfvars']		= isset($_POST['con_sfvars']);
	$ins[$i]['con_sfglobals']	= isset($_POST['con_sfglobals']);
