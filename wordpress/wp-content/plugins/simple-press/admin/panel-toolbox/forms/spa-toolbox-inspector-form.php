...
jQuery(document).ready(function() {
	jQuery('#sfinspectorform').ajaxForm({
		target: '#sfmsgspot',
		success: function() {
	...
	spa_paint_open_tab(spa_text('Toolbox')." - ".spa_text('Data Inspector'));
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Control Data'), false, '', true);
				spa_paint_checkbox(spa_text('sfvars'), "con_sfvars", $ins['con_sfvars']);
				spa_paint_checkbox(spa_text('sfglobals'), "con_sfglobals", $ins['con_sfglobals']);
