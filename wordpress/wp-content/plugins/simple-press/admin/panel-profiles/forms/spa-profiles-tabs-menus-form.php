...
$LastChangedDate: 2012-12-21 08:47:31 -0700 (Fri, 21 Dec 2012) $
$Rev: 9564 $
*/
...
jQuery(document).ready(function() {
	jQuery('#sptabsmenusform').ajaxForm({
		target: '#sfmsgspot',
		success: function() {
			jQuery('#sfreloadptm').click();
...
#== CUSTOM FIELDS Tab ============================================================
	...
	spa_paint_open_tab(spa_text('Profiles')." - ".spa_text('Tabs'));
