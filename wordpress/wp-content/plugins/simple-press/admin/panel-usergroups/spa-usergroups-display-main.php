...
$LastChangedDate: 2012-12-02 16:32:11 -0700 (Sun, 02 Dec 2012) $
$Rev: 9457 $
*/
...
<?php
						...
						$image = SFADMINIMAGES;
?>
						<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Edit User Group'),0,0); ?>" onclick="spjLoadForm('editusergroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $usergroup->usergroup_id; ?>');" />
					</td>
					<td style="padding:10px 0;">
						<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Delete User Group'),0,0); ?>" onclick="spjLoadForm('delusergroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $usergroup->usergroup_id; ?>');" />
					</td>
				</tr>
