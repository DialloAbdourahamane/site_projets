...
?>
		...
		<input type="submit" class="button-primary" id="sfmemberdel<?php echo $usergroup_id; ?>" name="sfmemberdel<?php echo $usergroup_id; ?>" onclick="javascript:jQuery('#dmember_id<?php echo $usergroup_id; ?> option').each(function(i) {jQuery(this).attr('selected', 'selected');});" value="<?php spa_etext('Delete/Move Members'); ?>" />
		<input type="button" class="button-primary" onclick="javascript:jQuery('#members-<?php echo $usergroup_id; ?>').html('');" id="sfmemberdel<?php echo $usergroup_id; ?>" name="delmemberscancel<?php echo $usergroup_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>
	</form>
