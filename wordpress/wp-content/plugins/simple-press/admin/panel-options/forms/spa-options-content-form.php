...
#== POSTS Tab ============================================================
	...
	spa_paint_open_tab(spa_text('Options').' - '.spa_text('Content Settings'));
		...
		spa_paint_open_panel();
			spa_paint_open_fieldset(spa_text('Spam Posts'), true, 'spam-links');
				spa_paint_input(spa_text('Maximum links allowed in post (if allowed above, 0 = unlimited)'), 'sfmaxlinks', $sfoptions['sfmaxlinks']);
