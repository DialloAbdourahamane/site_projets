...
?>
		...
		<input type="submit" class="button-primary" id="sfmembernew<?php echo $rank_id; ?>" name="sfmembernew<?php echo $rank_id; ?>" onclick="javascript:jQuery('#amember_id<?php echo $rank_id; ?> option').each(function(i) {jQuery(this).attr('selected', 'selected');});" value="<?php spa_etext('Add Members'); ?>" />
