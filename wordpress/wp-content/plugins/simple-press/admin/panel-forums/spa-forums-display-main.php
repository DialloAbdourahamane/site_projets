...
<?php
						...
						$image = SFADMINIMAGES;
?>
						<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Add Group Permission'),1,0); ?>" onclick="spjLoadForm('groupperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $group->group_id; ?>');" />
						<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Edit Group'),0,0); ?>" onclick="spjLoadForm('editgroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $group->group_id; ?>');" />
						<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Delete Group'),0,0); ?>" onclick="spjLoadForm('deletegroup', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $group->group_id; ?>');" />
					</td>
				</tr>
...
function spa_paint_group_forums($groupid, $parent, $parentname, $level) {
	...
	<?php
			...
			$image = SFADMINIMAGES;
	?>
			<input id="sfreloadpb<?php echo $forum->forum_id; ?>" type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('View Forum Permissions'),1,0); ?>" onclick="spjLoadForm('forumperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $forum->forum_id; ?>');" />
			<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Edit Forum'),0,0); ?>" onclick="spjLoadForm('editforum', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $forum->forum_id; ?>');" />
			<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Delete Forum'),0,0); ?>" onclick="spjLoadForm('deleteforum', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $forum->forum_id; ?>');" />
