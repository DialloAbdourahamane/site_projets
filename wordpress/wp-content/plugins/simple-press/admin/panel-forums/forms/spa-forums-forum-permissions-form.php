...
<?php
								...
								$image = SFADMINIMAGES;
?>
								<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Edit Permission Set'),0,0); ?>" onclick="spjLoadForm('editperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $perm->permission_id; ?>');" />
								<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Delete Permission Set'),0,0); ?>" onclick="spjLoadForm('delperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $perm->permission_id; ?>');" />
							</td>
			   			</tr>
...
<?php
								...
								$image = SFADMINIMAGES;
?>
								<input type="button" class="button button-highlighted" value="<?php echo sp_splice(spa_text('Add Permission'),0,0); ?>" onclick="spjLoadForm('addperm', '<?php echo $base; ?>', '<?php echo $target; ?>', '<?php echo $image; ?>', '<?php echo $forum->forum_id; ?>', 'sfopen');" />
			   				</td>
						</tr>
