...
function spa_themes_list_form() {
	...
	spa_paint_open_tab(spa_text('Available Themes')." - ".spa_text('Select Simple:Press Theme'));
...
?>
                ...
                jQuery(document).ready(function() {
                	jQuery('#sftheme-<?php echo esc_js($curTheme['theme']); ?>').ajaxForm({
                		target: '#sfmsgspot',
                		success: function() {
                            jQuery('#sfreloadtlist').click();
