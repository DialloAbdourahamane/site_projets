...
$LastChangedDate: 2012-12-10 09:43:05 -0700 (Mon, 10 Dec 2012) $
$Rev: 9497 $
*/
...
function sp_MemberListPageLinks($args='', $label='', $toolTip='') {
	...
	if(isset($_POST['allmembers'])) {
		...
		if (isset($_GET['page'])) $sfvars['page'] = sp_esc_int($_GET['page']);
	...
	$out.= $label;
	$out.= sp_page_prev($sfvars['page'], $showLinks, SPMEMBERLIST, $pageLinkClass, $iconClass, $prevIcon, $nextIcon, $toolTip, $search, $ug);
	...
	$out.= sp_page_next($sfvars['page'], $totalPages, $showLinks, SPMEMBERLIST, $pageLinkClass, $iconClass, $prevIcon, $nextIcon, $toolTip, $search, $ug);
	$out.= "</div>\n";
