...
$LastChangedDate: 2013-01-20 05:03:39 -0700 (Sun, 20 Jan 2013) $
$Rev: 9751 $
*/
...
function sp_ListForumName($args='', $toolTip='', $label='') {
	...
	$toolTip 	= str_ireplace('%NAME%', htmlspecialchars($spThisListTopic->forum_name, ENT_QUOTES), $toolTip);
...
function sp_ListTopicName($args='', $toolTip='') {
	...
	$toolTip	= esc_attr($toolTip);
	$toolTip 	= str_ireplace('%NAME%', htmlspecialchars($spThisListTopic->topic_name, ENT_QUOTES), $toolTip);
	$truncate	= (int) $truncate;
	$echo		= (int) $echo;
	$get		= (int) $get;
