...
function sp_track_online() {
	...
	$forumId = (isset($sfvars['forumid'])) ? $sfvars['forumid'] : 0;
	$topicId = (isset($sfvars['topicid'])) ? $sfvars['topicid'] : 0;
	...
	if ($track) {
		...
		spdb_query("INSERT INTO ".SFTRACK."
			 	   (trackuserid, trackname, forum_id, topic_id, trackdate, pageview) VALUES
			 	   ($trackUserId, '$trackName', $forumId, $topicId, '$now', '$pageview')");
		$spThisUser->trackid = $sfvars['insertid'];
