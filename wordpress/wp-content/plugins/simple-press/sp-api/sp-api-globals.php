...
Simple:Press
Global defs
$LastChangedDate: 2013-01-20 10:29:52 -0700 (Sun, 20 Jan 2013) $
$Rev: 9752 $
*/
...
function sp_setup_globals() {
	global $sfglobals, $current_user, $SPCACHE, $sfmeta, $SFDEVICE;
	...
	if($SFDEVICE == 'mobile') $sfglobals['display']['editor']['toolbar'] = true;
